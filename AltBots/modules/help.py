...
HELP_BUTTON = [
    ...
    [
      ...
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/+NdfeDacwEyBiMzY1")
    ]
  ]
...
async def help_spam(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own SPAM Bots !! @Pswaggerkarthik", cache_time=0, alert=True)
...
async def help_raid(event):
    if event.query.user_id in SUDO_USERS:
        ...
        await event.answer("Make Your Own SPAM Bots !! @swaggerkarthik", cache_time=0, alert=True)
